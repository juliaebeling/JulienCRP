...
private:
	...
	bool havePhotons;
	bool haveNeutrinos;
    ref_ptr<Density> dens;
	
public:
	HadronicInteraction(ref_ptr<Density> dens = 0, bool electrons = true, bool photons = true, bool neutrinos = true);
    void setDensity(ref_ptr<Density> d);
